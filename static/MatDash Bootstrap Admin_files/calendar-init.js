...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var calendarEventsList = [];  // Crée une variable pour stocker les événements

  async function chargerEvenements() {
    
    try {
        const response = await fetch("/etu/api/");
        const data = await response.json();
        calendarEventsList = data;

        // Ici, on attend que les événements soient récupérés avant d’exécuter la suite du code
        initialiserCalendrier(calendarEventsList);
    } catch (error) {
  ...
  function initialiserCalendrier(calendarEventsList){
